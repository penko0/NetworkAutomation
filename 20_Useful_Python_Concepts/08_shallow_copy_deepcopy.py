...
# my_list2.append(333)
# my_list2[1] = 'test' #When we make changes to thge first index , it does not affect the other list
my_list1[1][0] = 'new_msg' #When we make changes to nested objects inside a list, it affects both lists
